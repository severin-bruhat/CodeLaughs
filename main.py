...
hashtags = [
    "#CodeLaughs #developerhumor #developerhumour",
    "#ProgrammingHumour #ProgrammingHumor #codingjoke",
    "#DevLife #coderhumor #coderhumour",
    "#TechHumor #TechHumour #DevFun",
    "#CodeJokes #programming",
    "#ProgrammerHumour #ProgrammerHumor, #developer",
    "#TechJokes #CodingLife",
    "#GeekHumor #GeekHumor #programmerlife",
    "#NerdyLaughs #coderlife",
    "#ComputerHumor #CodingComedy",
    "#TechLaughs #softwaredevelopment",
    "#DevComedy #CodeFunnies ",
    "#CodeFunny #LaughAtCode",
    "#ProgrammerLaughs #NerdHumor",
    "#TechFunnies #Geek",
    "#NerdJokes #programmingfunnies",
    "#TechHumour #TechHumor",
    "#coding #developerlife ",
    "#programmingJoke #programming #developer",
    "#DeveloperLaughs #CodingComedy",
]
